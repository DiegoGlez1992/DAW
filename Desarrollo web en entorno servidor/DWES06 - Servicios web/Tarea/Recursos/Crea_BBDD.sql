...
-- 5.- Datos para las tablas de la base de datos
-- 5.1 .- Tabla familias
INSERT INTO
  `familias`
VALUES
...
VALUES
  ...
  (
    4,
    'Sony Bravia 32IN FULLHD KDL-32BX400',
    'BRAVIA2BX400',
  ...
  (
    22,
    'Samsung N150 10.1LED N450 1GB 250GB BAT6 BT W7R',
    'SMSN150101LD',
  ...
  (
    23,
    'Samsung SMX-C200PB EDC ZOOM 10X',
    'SMSSMXC200PB',
...
-- 5.5 .- Tabla usuarios
-- Creamos un par de usuarios de prueba, vamos a utilizar sha256
...
-- 6.- Tabla de LOG
-- 5.1 .- Crea tabla de 'log'
create table if not exists `log` (
  `contador` int(11) NOT NULL,
  `cod_producto` varchar(12) COLLATE utf8_spanish_ci NOT NULL,
  `fecha` date NOT NULL
) ENGINE = InnoDB DEFAULT CHARSET = utf8 COLLATE = utf8_spanish_ci;

-- 5.1 .- Indices de la tabla 'log'
ALTER TABLE
  `log`
ADD
  PRIMARY KEY (`contador`);

-- 5.1 .- AUTO_INCREMENT de la tabla 'log'
ALTER TABLE
  `log`
MODIFY
